...
class Stg_MA_Breakout : public Strategy {
 public:
  ...
  void OnInit() {
    ...
    switch (::MA_Breakout_Type) {
      case STG_MA_BREAKOUT_TYPE_AMA:  // AMA
      {
        ...
        SetIndicator(new Indi_AMA(_indi_params, ::MA_Breakout_Indi_AMA_SourceType), ::MA_Breakout_Type);
        break;
      }
      case STG_MA_BREAKOUT_TYPE_DEMA:  // DEMA
      {
        ...
        _indi_params.SetTf(Get<ENUM_TIMEFRAMES>(STRAT_PARAM_TF));
        SetIndicator(new Indi_DEMA(_indi_params, ::MA_Breakout_Indi_DEMA_SourceType), ::MA_Breakout_Type);
        break;
      }
      case STG_MA_BREAKOUT_TYPE_FRAMA:  // FrAMA
      {
        ...
        _indi_params.SetTf(Get<ENUM_TIMEFRAMES>(STRAT_PARAM_TF));
        SetIndicator(new Indi_FrAMA(_indi_params, ::MA_Breakout_Indi_FrAMA_SourceType), ::MA_Breakout_Type);
        break;
      }
      case STG_MA_BREAKOUT_TYPE_ICHIMOKU:  // Ichimoku
      {
        ...
        _indi_params.SetTf(Get<ENUM_TIMEFRAMES>(STRAT_PARAM_TF));
        SetIndicator(new Indi_Ichimoku(_indi_params, ::MA_Breakout_Indi_Ichimoku_SourceType), ::MA_Breakout_Type);
        break;
      }
      case STG_MA_BREAKOUT_TYPE_MA:  // MA
      {
        ...
        _indi_params.SetTf(Get<ENUM_TIMEFRAMES>(STRAT_PARAM_TF));
        SetIndicator(new Indi_MA(_indi_params, ::MA_Breakout_Indi_MA_SourceType), ::MA_Breakout_Type);
        break;
      }
      case STG_MA_BREAKOUT_TYPE_PRICE_CHANNEL:  // Price Channel
      {
        ...
        _indi_params.SetTf(Get<ENUM_TIMEFRAMES>(STRAT_PARAM_TF));
        SetIndicator(new Indi_PriceChannel(_indi_params, ::MA_Breakout_Indi_PriceChannel_SourceType), ::MA_Breakout_Type);
        break;
      }
      case STG_MA_BREAKOUT_TYPE_SAR:  // SAR
      {
        ...
        _indi_params.SetTf(Get<ENUM_TIMEFRAMES>(STRAT_PARAM_TF));
        SetIndicator(new Indi_SAR(_indi_params, ::MA_Breakout_Indi_SAR_SourceType), ::MA_Breakout_Type);
        break;
      }
      case STG_MA_BREAKOUT_TYPE_TEMA:  // TEMA
      {
        ...
        _indi_params.SetTf(Get<ENUM_TIMEFRAMES>(STRAT_PARAM_TF));
        SetIndicator(new Indi_TEMA(_indi_params, ::MA_Breakout_Indi_TEMA_SourceType), ::MA_Breakout_Type);
        break;
      }
      case STG_MA_BREAKOUT_TYPE_VIDYA:  // VIDYA
      {
        ...
        _indi_params.SetTf(Get<ENUM_TIMEFRAMES>(STRAT_PARAM_TF));
        SetIndicator(new Indi_VIDYA(_indi_params, ::MA_Breakout_Indi_VIDYA_SourceType), ::MA_Breakout_Type);
        break;
      }
  ...
  bool SignalOpen(ENUM_ORDER_TYPE _cmd, int _method = 0, float _level = 0.0f, int _shift = 0) {
    ...
    IndicatorData *_indi = GetIndicator(::MA_Breakout_Type);
